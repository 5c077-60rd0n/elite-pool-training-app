...
export function PageWrapper({ title, children }: PageWrapperProps) {
  return (
    <main className="mx-auto w-full max-w-5xl px-4 pb-24 pt-3 sm:px-6 sm:pb-28 sm:pt-4">
      <div className="mb-3 sm:mb-4">
        <p className="text-[11px] uppercase tracking-[0.24em] text-flash-400">Fargo Climb CueSports Coaching</p>
