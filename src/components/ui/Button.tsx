...
export function Button({ children, className = '', variant = 'primary', ...props }: ButtonProps) {
  const base =
    'min-h-11 min-w-11 rounded-xl px-4 py-2 font-body text-sm font-semibold uppercase tracking-[0.08em] transition duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cue-400';
  const style =
    variant === 'primary'
